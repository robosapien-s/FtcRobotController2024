...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2291.20131816455; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2240.607623708086; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1865.598673175713; // x position of the perpendicular encoder (in tick units)
    }
